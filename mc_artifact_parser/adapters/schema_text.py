...
class SchemaTextParser:
    ...
    def parse_lines(self, lines: list[str], source_path: str, artifact_type: str) -> ArtifactParseResult:
        result = ArtifactParseResult(source_path=source_path, artifact_type=artifact_type)
